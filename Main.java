...
public class Main {
    public static void main(String[] args) {
        ...
        team1.addWarriorToTeam(new Swordman("Robin", 250, new Sword(25)))
        .addWarriorToTeam(new Swordman("Bobin", 200, new Sword(50), new Buckler(50, 100)));
        ...
        team2.addWarriorToTeam(new Archer("John", 150, new Bow(100, 50)))
        .addWarriorToTeam(new Archer("Adam", 200, new Bow(75, 70)));
